...
% array elements. Index must not exceed 6.
% 
...
x = [-5, -3, -1, 0, 2, 4, 6] %Creation of the x vectors
y = [-25, -9, -1, 0, 4, 16, 36] %Creation of the y vectors
...
N = 101;             %This helps to create 101 points
h = (7-(-3))/(N-1); %This finds the difference between 2 adjacent values
x = zeros(1,N);     %This creates a row vector with N or 101 values for X-axis
